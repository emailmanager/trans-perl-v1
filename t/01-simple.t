...
# generate a new API method. The Emailmanager service provides a special token
# for testing purposes ('EMAILMANAGER_API_TEST').
my $api = WWW::Emailmanager->new('EMAILMANAGER_API_TEST');

ok($api, 'Got a proper WWW::Emailmanager object');
...
$api->{token} = 'EMAILMANAGER_API_TEST';
